...
cucm = 'xxx.xxx.xxx.xxx' # IP Address of CUCM
axl_username = 'axlapiuser' # AXL API User - Set in CUCM Applications users
password = 'password' # add the axl user password
version = '12.5' # Current version of cucm
